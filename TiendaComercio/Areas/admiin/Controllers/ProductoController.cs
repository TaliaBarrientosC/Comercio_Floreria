...
using TiendaComercio.Models;

namespace TiendaComercio.Areas.admiin.Controllers
{
    public class ProductoController : Controller
    {
        private TiendaaEntities db = new TiendaaEntities();
        ...
        // GET: admiin/Producto/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: admiin/Producto/Create
